    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(x -> x
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/games/getAllGames").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/api/users/auth/me").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/games/filter/ageGroup").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/games/filter/difficultyLevel").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/games/filter/gameType").authenticated()
