...
public interface UserProgressService {
    ...
    UserProgress createUserProgress(User user, Games games);
    ...
    // Get the progress of a user for a specific games
    Optional<UserProgress> getUserProgressForTask(Long userId, Long taskId);

    // Update the progress of a user for a specific games
    ...
    // Get a list of users with the highest progress for a specific games
